...
export default function AdminLoginPage() {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (authError || !user) {
                setErrorMsg(authError || "Failed to log in.");
                setIsLoading(false);
                return;
            }

            // 2. Fetch user profile from Firestore to confirm role
                        ...
                        <form onSubmit={handleLogin} className="space-y-6">
                            <div className="space-y-4">
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="email" className="text-emerald-900 font-medium">Admin Email</Label>
                                    <div className="relative">
                                        ...
                                        <Input
                                            id="email"
                                            type="email"
                                            placeholder="admin@harithakarmasena.com"
